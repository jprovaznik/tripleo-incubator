...
1. Perform setup of your undercloud. The 1 1024 15 is CPU count, memory in MB, disk
   in GB for your test nodes.
        ...
        user-config
        setup-baremetal 1 1024 15 undercloud
