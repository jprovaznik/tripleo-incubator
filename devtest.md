...
1. Create some 'baremetal' node(s) out of KVM virtual machines.
   ...
   (MB), disk size (GB), architecture (i386, amd64), vm count.
...
1. Perform setup of your seed cloud. The 1 1024 10 i386 is CPU count, memory in MB,
   disk in GB, architecture (i386, amd64) for your test nodes.

        SERVICE_TOKEN=unset setup-endpoints 192.0.2.1
        user-config
        setup-baremetal 1 1024 10 i386 seed
...
1. Perform setup of your undercloud. The 1 1024 10 is CPU count, memory in MB, disk
   in GB, architecture (i386, amd64) for your test nodes.
        ...
        user-config
        setup-baremetal 1 1024 10 i386 undercloud
